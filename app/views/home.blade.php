...
@section('content')
	...
	<div class="row marketing">
		<div class="col-md-6">
			...
			<p>Yes! A person may transfer as a voter to another registration centre within the constituency or outside the constituency. The person is required to present himself/ herself to the particular registration centre or constituency with their certificate.</p>
